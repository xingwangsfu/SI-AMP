function [out1,out2,out3,out4,out5,out6,out7,out8,out9] = ...
    gampEst_v2(scaEstIn, scaEstOut, A, Z, sigmaS, opt)
...
while ~stop
    ...
    if compVal
        [xhat,xvar,valIn] = scaEstIn.estim_v2(rhat, rvar*scaleFac, Z, sigmaS);
        valIn = sum( valIn(:) ) + valMsg;
    else
        [xhat,xvar] = scaEstIn.estim_v2(rhat, rvar*scaleFac, Z, sigmaS);
    end
