classdef SparseScaEstim < handle
    ...
    methods
        ...
        % Compute posterior mean and variance from Gaussian estimate and
        % side information
        function [xhat, xvar, klDivNeg, py1] = estim_v2(obj, y, yvar, z, zvar)
            
            y = (z./zvar+y./yvar)./(1./zvar+1./yvar);
            yvar = 1./(1./zvar+1./yvar);
            % Compute the activity probabilities
            if ~obj.LogLikeFlag
                % This EstimIn class does not implement the loglikey
                % method, thus convert from probability domain to log-prob
